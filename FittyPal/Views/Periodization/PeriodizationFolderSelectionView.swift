//
//  PeriodizationFolderSelectionView.swift
//  FittyPal
//
...
struct PeriodizationFolderSelectionView: View {
    @Environment(\.dismiss) private var dismiss
    @Binding var selectedFolders: [PeriodizationFolder]
    let folders: [PeriodizationFolder]

    @State private var localSelection: Set<UUID>

    init(selectedFolders: Binding<[PeriodizationFolder]>, folders: [PeriodizationFolder]) {
...
#Preview {
    let folder1 = PeriodizationFolder(name: "Forza", colorHex: "#FF0000", order: 0)
    let folder2 = PeriodizationFolder(name: "Ipertrofia", colorHex: "#00FF00", order: 1)
    let folder3 = PeriodizationFolder(name: "Condizionamento", colorHex: "#0000FF", order: 2)
